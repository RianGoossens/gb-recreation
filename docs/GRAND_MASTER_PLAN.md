...
- [~] Decode the cartridge's object table so the extracted levels carry their real enemies
  ...
  - [ ] Implement moving platforms so the lifts can go in: a level-format marker, the two axes and their measured cycles (60 px over 120 frames vertical, 53 px over 106 frames horizontal), and Mario being carried by one
